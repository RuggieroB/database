...
INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Richard Gere",DATE("1949"),"USA");

INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Julia Roberts",DATE("1967"),"USA");

INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Robin Williams",DATE("1951"),"USA");

INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Marcello Mastroianni",DATE("1924"),"Italia");

INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Sophia Loren",DATE("1934"),"Italia");

INSERT INTO Attori(Nome,AnnoNascita,Nazionalità) VALUES("Gérard Depardieu",DATE("1948"),"Francia");


INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Pretty Woman",DATE("1990"),"USA","Garry Marshall","Romantico","125","14");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Lo sceicco bianco",DATE("1952"),"Italia","Federico Fellini","Commedia","85","19");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Amarcord",DATE("1973"),"Italia","Federico Fellini","Commedia, drammatico","123","21");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("E.T, l'extra-terrestre",DATE("1982"),"USA","Steven Spielberg","Avventura, fantascienza","115","10");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Casablanca",DATE("1942"),"USA","Michael Curtiz","Drammatico, sentimentale","102","15");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("L'arca di Noè",DATE("1928"),"USA","Michael Curtiz","Drammatico, guerra","135","14");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Goodbye again",DATE("1933"),"USA","Michael Curtiz","Commedia, sentimentale","66","14");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Salvate il soldato Ryan",DATE("1998"),"USA","Steven Spielberg","Guerra, drammatico, azione, storico","169","15");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Mrs. Doubtfire - Mammo per sempre",DATE("1993"),"USA","Chris Columbus","Commedia, drammatico","120","14");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("C'eravamo tanto amati",DATE("1974"),"Italia","Ettore Scola","Commedia, drammatico","120","22");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Prêt-à-porter",DATE("1994"),"USA","Robert Altam","Commedia","133","43");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("La ciociara",DATE("1960"),"Italia","Vittorio de Sica","Drammatico, guerra","100","17");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Godzilla",DATE("1954"),"Giappone","Ishirō Honda","Fantascienza","98","18");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Stargate",DATE("1994"),"Francia","Roland Emmerich","Fantascienza","125","20");

INSERT INTO Film(Titolo,AnnoProduzione,Nazionalità,Regista,Genere,Durata,NumeroAttori) VALUES("Carmi amici miei...",DATE("1974"),"Francia","Pierre Tchernia","Commedia","94","15");
...
INSERT INTO Sale(Nome,Città,Posti) VALUES("Arsenale","Pisa (PI)","110");

INSERT INTO Sale(Nome,Città,Posti) VALUES("Lumiere","Pisa (PI)","280");

INSERT INTO Sale(Nome,Città,Posti) VALUES("Ossau","Pisa (PI)","200");

INSERT INTO Sale(Nome,Città,Posti) VALUES("Matropolitan","Napoli (NA)","300");

INSERT INTO Sale(Nome,Città,Posti) VALUES("Arcobaleno","Napoli (NA)","195");
...
SELECT Sale.CodSala,Sale.Nome From Sale WHERE Sale.Città="Pisa" ORDER BY Sala.Nome ASC;
...
SELECT Film.CodFilm,Film.Titolo FROM Film WHERE (Film.Nazionalità="Giappone" OR Film.Nazionalità="Francia") AND (Film.AnnoProduzione > DATE("1990")) ORDER BY Film.CodFilm ASC;

SELECT Film.CodFilm,Film.Titolo,Film.Durata FROM Film WHERE (Film.Nazionalità="Giappone" OR Film.Nazionalità="Francia") AND (Film.AnnoProduzione > DATE("1990")) ORDER BY Film.CodFilm ASC;
...
SELECT COUNT(Sale) AS Totale_Sale FROM Sale WHERE Sale.Città="Pisa" HAVING Sale.Posti > 60;

SELECT COUNT(Sale.Posti) AS Totale_Posti FROM Sale WHERE Sale.Città="Pisa";
